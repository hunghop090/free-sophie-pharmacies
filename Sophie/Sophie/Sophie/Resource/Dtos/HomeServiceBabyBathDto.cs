...
{
    public class HomeServiceBabyBathDto
    {
        //[NotMapped]
        ...
        [DefaultValue("ByBabyBath")]
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByBabyBath;//[ByPhone, ByHome, ByHospital, ByFastPhone, BabyBathService, CareSickService, BloodCollectionService, PhysiotherapyService]
