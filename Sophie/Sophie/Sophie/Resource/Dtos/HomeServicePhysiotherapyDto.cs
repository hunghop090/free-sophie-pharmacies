...
{
    public class HomeServicePhysiotherapyDto
    {
        //[NotMapped]
        ...
        [DefaultValue("ByPhysiotherapy")]
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByPhysiotherapy;//[ByPhone, ByHome, ByHospital, ByFastPhone, BabyBathService, CareSickService, BloodCollectionService, PhysiotherapyService]
