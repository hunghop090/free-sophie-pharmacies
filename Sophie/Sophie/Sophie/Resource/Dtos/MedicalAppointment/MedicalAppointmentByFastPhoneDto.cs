...
{
    public class MedicalAppointmentByFastPhoneDto
    {
        //[NotMapped]
        ...
        [DefaultValue("ByFastPhone")]
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByFastPhone; // [ByPhone, ByHome, ByHospital, ByFastPhone]
        ...
        public DateTime? Date { get; set; } = DateTimes.Now();
        ...
        public DateTime? Time { get; set; } = DateTimes.Now();
