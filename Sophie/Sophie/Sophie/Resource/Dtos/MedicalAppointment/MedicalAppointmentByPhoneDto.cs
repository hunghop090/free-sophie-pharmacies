...
{
    public class MedicalAppointmentByPhoneDto
    {
        //[NotMapped]
        ...
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByPhone; // [ByPhone, ByHome, ByHospital, ByFastPhone]
