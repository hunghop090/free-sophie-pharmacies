...
{
    public class MedicalAppointmentByHomeDto
    {
        //[NotMapped]
        ...
        [DefaultValue("ByHome")]
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByHome; // [ByPhone, ByHome, ByHospital, ByFastPhone]
