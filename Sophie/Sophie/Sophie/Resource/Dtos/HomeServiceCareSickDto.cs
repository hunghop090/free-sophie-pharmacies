...
{
    public class HomeServiceCareSickDto
    {
        //[NotMapped]
        ...
        [DefaultValue("ByCareSick")]
        public TypeMedicalAppointment TypeMedicalAppointment { get; set; } = TypeMedicalAppointment.ByCareSick;//[ByPhone, ByHome, ByHospital, ByFastPhone, BabyBathService, CareSickService, BloodCollectionService, PhysiotherapyService]
