...
namespace Sophie.Controllers.API
{
    public class BaseController : ControllerBase
    {
        ...
        public readonly ApplicationSettings _applicationSettings;// Inject Data

        public BaseController(ILogManager logManager, IMapper mapper, IConfiguration configuration, IStringLocalizer localizer, IAuthRepository authRepo,
