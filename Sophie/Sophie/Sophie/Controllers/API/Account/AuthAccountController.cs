...
namespace Sophie.Controllers.API
{
    ...
    {
        private readonly ILog _log4net = log4net.LogManager.GetLogger(typeof(AuthAccountController));
        ...
        public AuthAccountController(ILogManager logManager, IMapper mapper, IConfiguration configuration, IStringLocalizer localizer, IAuthRepository authRepo, IOptions<ApplicationSettings> applicationSettingAccessor,
            IHttpContextAccessor httpContextAccessor, IEmailSender emailSender, ILogger<AuthAccountController> logger, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, SignInManager<ApplicationUser> signInManager,
        ...
        /// <returns></returns>
        // GET: api/account/AuthAccount/GoogleSignIn
        [ProducesResponseType(typeof(object), 200)]
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        // GET: api/account/AuthAccount/FacebookSignIn
        [ProducesResponseType(typeof(object), 200)]
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        // GET: api/account/AuthAccount/AppleSignIn
        [ProducesResponseType(typeof(object), 200)]
        ...
        // GET: api/account/AuthAccount/Register
        [HttpPost("Register")]
        [AllowAnonymous]
        ...
        // POST: api/account/AuthAccount/Login
        [HttpPost("Login")]
        [AllowAnonymous]
        ...
        // GET: api/account/AuthAccount/RefreshToken
        ...
        // GET: api/account/AuthAccount/Logout
        [HttpPost("Logout")]
        ...
        // GET: api/account/AuthAccount/Check
        [HttpPost("Check")]
        [AllowAnonymous]
        ...
        private async Task<List<Claim>> RenderClaimsAsync(Account account)
        {
            ...
            claims.Add(new Claim(JwtSecurityTokenValidator.Prefix_Role, RolePrefix.Account));
        ...
        //// GET: api/account/AuthAccount/SendEmailRegister
        ...
        //// POST: api/account/AuthAccount/CheckTokenRegister
        ...
        //// POST: api/account/AuthAccount/ConfirmEmailRegister
        ...
        //// GET: api/account/AuthAccount/SendEmailForgotPassword
        ...
        //// POST: api/account/AuthAccount/CheckTokenForgotPassword
        ...
        ///// </summary>
        ///// <returns>Result status comfirm email for admin user</returns>
        //// GET: api/account/AuthAccount/ConfirmEmailForgotPassword
