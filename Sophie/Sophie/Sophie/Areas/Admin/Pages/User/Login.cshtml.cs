...
namespace Sophie.Areas.Admin.Pages.User
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(IConfiguration config, IAuthRepository authRepo, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, ILogger<LoginModel> logger)
        {
            _config = config;
            _authRepo = authRepo;
