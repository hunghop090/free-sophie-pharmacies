...
namespace Sophie.Areas.Admin.ShopPage
{
    ...
    public class ListProductModel : PageModel
    {
        ...
        public ListProductModel(IConfiguration config, IMapper mapper, IProductRepository productRepository)
        {
            _config = config;
            _mapper = mapper;
        ...
        public Task<JsonResult> OnGetList()
        {
            ...
            PagingResult<Product> listSearch = _productRepository.ListProduct(paging);
            ListProducts = listSearch.Result;
